...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 24, 2017 at 12:33 PM
...
--
-- Table structure for table `frp_assets`
--

CREATE TABLE `frp_assets` (
...
--
-- Dumping data for table `frp_assets`
--

INSERT INTO `frp_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(55, 1, 105, 106, 1, 'com_fields', 'com_fields', '{}'),
(56, 1, 107, 108, 1, 'com_associations', 'com_associations', '{}'),
(57, 1, 109, 110, 1, '#__languages.2', '#__languages.2', '{}'),
(58, 18, 72, 73, 2, 'com_modules.module.87', 'Language Switcher', '{}');

-- --------------------------------------------------------

--
-- Table structure for table `frp_associations`
--

CREATE TABLE `frp_associations` (
...
--
-- Table structure for table `frp_banners`
--

CREATE TABLE `frp_banners` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `frp_banner_clients`
--

CREATE TABLE `frp_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `frp_banner_tracks`
--

CREATE TABLE `frp_banner_tracks` (
...
--
-- Table structure for table `frp_categories`
--

CREATE TABLE `frp_categories` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `frp_categories`
--

INSERT INTO `frp_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- Table structure for table `frp_contact_details`
--

CREATE TABLE `frp_contact_details` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `frp_content`
--

CREATE TABLE `frp_content` (
...
--
-- Table structure for table `frp_contentitem_tag_map`
--

CREATE TABLE `frp_contentitem_tag_map` (
...
--
-- Table structure for table `frp_content_frontpage`
--

CREATE TABLE `frp_content_frontpage` (
...
--
-- Table structure for table `frp_content_rating`
--

CREATE TABLE `frp_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `frp_content_types`
--

CREATE TABLE `frp_content_types` (
...
--
-- Dumping data for table `frp_content_types`
--

INSERT INTO `frp_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `frp_core_log_searches`
--

CREATE TABLE `frp_core_log_searches` (
...
--
-- Table structure for table `frp_extensions`
--

CREATE TABLE `frp_extensions` (
...
--
-- Dumping data for table `frp_extensions`
--

INSERT INTO `frp_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 0, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{\"name\":\"LIB_JOOMLA\",\"type\":\"library\",\"creationDate\":\"2008\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2017 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"https:\\/\\/www.joomla.org\",\"version\":\"13.1\",\"description\":\"LIB_JOOMLA_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"joomla\"}', '{\"mediaversion\":\"87b2601261debcb3e251cf2faf48792f\"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{\"name\":\"plg_system_updatenotification\",\"type\":\"plugin\",\"creationDate\":\"May 2015\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2017 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"updatenotification\"}', '{\"lastrun\":1503570039}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Table structure for table `frp_fields`
--

CREATE TABLE `frp_fields` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `frp_fields_categories`
--

CREATE TABLE `frp_fields_categories` (
...
--
-- Table structure for table `frp_fields_groups`
--

CREATE TABLE `frp_fields_groups` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `frp_fields_values`
--

CREATE TABLE `frp_fields_values` (
...
--
-- Table structure for table `frp_finder_filters`
--

CREATE TABLE `frp_finder_filters` (
...
--
-- Table structure for table `frp_finder_links`
--

CREATE TABLE `frp_finder_links` (
...
--
-- Table structure for table `frp_finder_links_terms0`
--

CREATE TABLE `frp_finder_links_terms0` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `frp_finder_links_terms1`
--

CREATE TABLE `frp_finder_links_terms1` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `frp_finder_links_terms2`
--

CREATE TABLE `frp_finder_links_terms2` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `frp_finder_links_terms3`
--

CREATE TABLE `frp_finder_links_terms3` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `frp_finder_links_terms4`
--

CREATE TABLE `frp_finder_links_terms4` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `frp_finder_links_terms5`
--

CREATE TABLE `frp_finder_links_terms5` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `frp_finder_links_terms6`
--

CREATE TABLE `frp_finder_links_terms6` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `frp_finder_links_terms7`
--

CREATE TABLE `frp_finder_links_terms7` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `frp_finder_links_terms8`
--

CREATE TABLE `frp_finder_links_terms8` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `frp_finder_links_terms9`
--

CREATE TABLE `frp_finder_links_terms9` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `frp_finder_links_termsa`
--

CREATE TABLE `frp_finder_links_termsa` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `frp_finder_links_termsb`
--

CREATE TABLE `frp_finder_links_termsb` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `frp_finder_links_termsc`
--

CREATE TABLE `frp_finder_links_termsc` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `frp_finder_links_termsd`
--

CREATE TABLE `frp_finder_links_termsd` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `frp_finder_links_termse`
--

CREATE TABLE `frp_finder_links_termse` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `frp_finder_links_termsf`
--

CREATE TABLE `frp_finder_links_termsf` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `frp_finder_taxonomy`
--

CREATE TABLE `frp_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `frp_finder_taxonomy`
--

INSERT INTO `frp_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `frp_finder_taxonomy_map`
--

CREATE TABLE `frp_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `frp_finder_terms`
--

CREATE TABLE `frp_finder_terms` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `frp_finder_terms_common`
--

CREATE TABLE `frp_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `frp_finder_terms_common`
--

INSERT INTO `frp_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `frp_finder_tokens`
--

CREATE TABLE `frp_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  `phrase` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Table structure for table `frp_finder_tokens_aggregate`
--

CREATE TABLE `frp_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `frp_finder_types`
--

CREATE TABLE `frp_finder_types` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `frp_languages`
--

CREATE TABLE `frp_languages` (
...
--
-- Dumping data for table `frp_languages`
--

INSERT INTO `frp_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 2),
(2, 57, 'vi-VN', 'Vietnamese (vi-VN)', 'Vietnamese (vi-VN)', 'vi', 'vi_vn', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `frp_menu`
--

CREATE TABLE `frp_menu` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `frp_menu`
--

INSERT INTO `frp_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Table structure for table `frp_menu_types`
--

CREATE TABLE `frp_menu_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `frp_menu_types`
--

INSERT INTO `frp_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site', 0);

-- --------------------------------------------------------

--
-- Table structure for table `frp_messages`
--

CREATE TABLE `frp_messages` (
...
--
-- Table structure for table `frp_messages_cfg`
--

CREATE TABLE `frp_messages_cfg` (
...
--
-- Table structure for table `frp_modules`
--

CREATE TABLE `frp_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `frp_modules`
--

INSERT INTO `frp_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
(87, 58, 'Language Switcher', '', '', 1, 'banner', 634, '2017-08-24 10:29:58', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_languages', 1, 1, '{\"header_text\":\"\",\"footer_text\":\"\",\"dropdown\":\"1\",\"dropdownimage\":\"1\",\"lineheight\":\"0\",\"image\":\"1\",\"show_active\":\"1\",\"full_name\":\"1\",\"inline\":\"1\",\"layout\":\"_:default\",\"moduleclass_sfx\":\"\",\"cache\":\"0\",\"cache_time\":\"900\",\"cachemode\":\"itemid\",\"module_tag\":\"div\",\"bootstrap_size\":\"0\",\"header_tag\":\"h3\",\"header_class\":\"\",\"style\":\"0\"}', 0, '*');

-- --------------------------------------------------------

--
-- Table structure for table `frp_modules_menu`
--

CREATE TABLE `frp_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `frp_modules_menu`
--

INSERT INTO `frp_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `frp_newsfeeds`
--

CREATE TABLE `frp_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `frp_overrider`
--

CREATE TABLE `frp_overrider` (
...
--
-- Table structure for table `frp_postinstall_messages`
--

CREATE TABLE `frp_postinstall_messages` (
...
--
-- Dumping data for table `frp_postinstall_messages`
--

INSERT INTO `frp_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `frp_redirect_links`
--

CREATE TABLE `frp_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `frp_schemas`
--

CREATE TABLE `frp_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `frp_schemas`
--

INSERT INTO `frp_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.7.4-2017-07-05');

-- --------------------------------------------------------

--
-- Table structure for table `frp_session`
--

CREATE TABLE `frp_session` (
...
--
-- Dumping data for table `frp_session`
--

INSERT INTO `frp_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('j05d8glam88149ign8su4asbh3', 1, 0, '1503570812', 'joomla|s:2924:\"\";', 634, 'admin'),
('qucusdslmkcgrvitvjklgd4m95', 0, 1, '1503570816', 'joomla|s:820:\"\";', 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `frp_tags`
--

CREATE TABLE `frp_tags` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `frp_tags`
--

INSERT INTO `frp_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
...
--
-- Table structure for table `frp_template_styles`
--

CREATE TABLE `frp_template_styles` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `frp_template_styles`
--

INSERT INTO `frp_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `frp_ucm_base`
--

CREATE TABLE `frp_ucm_base` (
...
--
-- Table structure for table `frp_ucm_content`
--

CREATE TABLE `frp_ucm_content` (
...
--
-- Table structure for table `frp_ucm_history`
--

CREATE TABLE `frp_ucm_history` (
...
--
-- Table structure for table `frp_updates`
--

CREATE TABLE `frp_updates` (
...
--
-- Dumping data for table `frp_updates`
--

INSERT INTO `frp_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
(1, 3, 0, 'Catalan', '', 'pkg_ca-ES', 'package', '', 0, '3.7.3.2', '', 'https://update.joomla.org/language/details3/ca-ES_details.xml', '', ''),
(2, 3, 0, 'Chinese Simplified', '', 'pkg_zh-CN', 'package', '', 0, '3.7.4.1', '', 'https://update.joomla.org/language/details3/zh-CN_details.xml', '', ''),
(3, 3, 0, 'Croatian', '', 'pkg_hr-HR', 'package', '', 0, '3.7.4.1', '', 'https://update.joomla.org/language/details3/hr-HR_details.xml', '', ''),
(4, 3, 0, 'Czech', '', 'pkg_cs-CZ', 'package', '', 0, '3.7.3.1', '', 'https://update.joomla.org/language/details3/cs-CZ_details.xml', '', ''),
(5, 3, 0, 'Danish', '', 'pkg_da-DK', 'package', '', 0, '3.7.5.1', '', 'https://update.joomla.org/language/details3/da-DK_details.xml', '', ''),
(6, 3, 0, 'Dutch', '', 'pkg_nl-NL', 'package', '', 0, '3.7.2.1', '', 'https://update.joomla.org/language/details3/nl-NL_details.xml', '', ''),
(7, 3, 0, 'Estonian', '', 'pkg_et-EE', 'package', '', 0, '3.7.0.1', '', 'https://update.joomla.org/language/details3/et-EE_details.xml', '', ''),
(8, 3, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '3.7.5.1', '', 'https://update.joomla.org/language/details3/it-IT_details.xml', '', ''),
(9, 3, 0, 'Khmer', '', 'pkg_km-KH', 'package', '', 0, '3.4.5.1', '', 'https://update.joomla.org/language/details3/km-KH_details.xml', '', ''),
(10, 3, 0, 'Korean', '', 'pkg_ko-KR', 'package', '', 0, '3.7.4.1', '', 'https://update.joomla.org/language/details3/ko-KR_details.xml', '', ''),
(11, 3, 0, 'Latvian', '', 'pkg_lv-LV', 'package', '', 0, '3.7.3.1', '', 'https://update.joomla.org/language/details3/lv-LV_details.xml', '', ''),
(12, 3, 0, 'Macedonian', '', 'pkg_mk-MK', 'package', '', 0, '3.6.5.1', '', 'https://update.joomla.org/language/details3/mk-MK_details.xml', '', ''),
(13, 3, 0, 'Norwegian Bokmal', '', 'pkg_nb-NO', 'package', '', 0, '3.7.4.1', '', 'https://update.joomla.org/language/details3/nb-NO_details.xml', '', ''),
(14, 3, 0, 'Norwegian Nynorsk', '', 'pkg_nn-NO', 'package', '', 0, '3.4.2.1', '', 'https://update.joomla.org/language/details3/nn-NO_details.xml', '', ''),
(15, 3, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '3.7.5.1', '', 'https://update.joomla.org/language/details3/fa-IR_details.xml', '', ''),
(16, 3, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '3.7.4.1', '', 'https://update.joomla.org/language/details3/pl-PL_details.xml', '', ''),
(17, 3, 0, 'Portuguese', '', 'pkg_pt-PT', 'package', '', 0, '3.7.0.1', '', 'https://update.joomla.org/language/details3/pt-PT_details.xml', '', ''),
(18, 3, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '3.7.0.1', '', 'https://update.joomla.org/language/details3/ru-RU_details.xml', '', ''),
(19, 3, 0, 'English AU', '', 'pkg_en-AU', 'package', '', 0, '3.6.5.1', '', 'https://update.joomla.org/language/details3/en-AU_details.xml', '', ''),
(20, 3, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '3.7.5.1', '', 'https://update.joomla.org/language/details3/sk-SK_details.xml', '', ''),
(21, 3, 0, 'English US', '', 'pkg_en-US', 'package', '', 0, '3.6.5.1', '', 'https://update.joomla.org/language/details3/en-US_details.xml', '', ''),
(22, 3, 0, 'Swedish', '', 'pkg_sv-SE', 'package', '', 0, '3.7.5.1', '', 'https://update.joomla.org/language/details3/sv-SE_details.xml', '', ''),
(23, 3, 0, 'Syriac', '', 'pkg_sy-IQ', 'package', '', 0, '3.4.5.1', '', 'https://update.joomla.org/language/details3/sy-IQ_details.xml', '', ''),
(24, 3, 0, 'Tamil', '', 'pkg_ta-IN', 'package', '', 0, '3.7.5.1', '', 'https://update.joomla.org/language/details3/ta-IN_details.xml', '', ''),
(25, 3, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '3.7.5.1', '', 'https://update.joomla.org/language/details3/th-TH_details.xml', '', ''),
(26, 3, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '3.7.2.1', '', 'https://update.joomla.org/language/details3/tr-TR_details.xml', '', ''),
(27, 3, 0, 'Ukrainian', '', 'pkg_uk-UA', 'package', '', 0, '3.7.1.1', '', 'https://update.joomla.org/language/details3/uk-UA_details.xml', '', ''),
...
(30, 3, 0, 'Basque', '', 'pkg_eu-ES', 'package', '', 0, '3.7.5.1', '', 'https://update.joomla.org/language/details3/eu-ES_details.xml', '', ''),
(31, 3, 0, 'Hindi', '', 'pkg_hi-IN', 'package', '', 0, '3.3.6.2', '', 'https://update.joomla.org/language/details3/hi-IN_details.xml', '', ''),
(32, 3, 0, 'German DE', '', 'pkg_de-DE', 'package', '', 0, '3.7.4.2', '', 'https://update.joomla.org/language/details3/de-DE_details.xml', '', ''),
(33, 3, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '3.7.5.1', '', 'https://update.joomla.org/language/details3/pt-BR_details.xml', '', ''),
(34, 3, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.7.4.2', '', 'https://update.joomla.org/language/details3/sr-YU_details.xml', '', ''),
(35, 3, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '3.7.2.1', '', 'https://update.joomla.org/language/details3/es-ES_details.xml', '', ''),
(36, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.6.5.1', '', 'https://update.joomla.org/language/details3/bs-BA_details.xml', '', ''),
(37, 3, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '3.7.4.2', '', 'https://update.joomla.org/language/details3/sr-RS_details.xml', '', ''),
(39, 3, 0, 'Bahasa Indonesia', '', 'pkg_id-ID', 'package', '', 0, '3.6.2.1', '', 'https://update.joomla.org/language/details3/id-ID_details.xml', '', ''),
(40, 3, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '3.7.2.1', '', 'https://update.joomla.org/language/details3/fi-FI_details.xml', '', ''),
...
(45, 3, 0, 'Welsh', '', 'pkg_cy-GB', 'package', '', 0, '3.7.0.1', '', 'https://update.joomla.org/language/details3/cy-GB_details.xml', '', ''),
...
(49, 3, 0, 'Irish', '', 'pkg_ga-IE', 'package', '', 0, '3.7.0.1', '', 'https://update.joomla.org/language/details3/ga-IE_details.xml', '', ''),
(50, 3, 0, 'Dzongkha', '', 'pkg_dz-BT', 'package', '', 0, '3.6.2.1', '', 'https://update.joomla.org/language/details3/dz-BT_details.xml', '', ''),
(51, 3, 0, 'Slovenian', '', 'pkg_sl-SI', 'package', '', 0, '3.7.5.1', '', 'https://update.joomla.org/language/details3/sl-SI_details.xml', '', ''),
(52, 3, 0, 'Spanish CO', '', 'pkg_es-CO', 'package', '', 0, '3.7.4.1', '', 'https://update.joomla.org/language/details3/es-CO_details.xml', '', ''),
(53, 3, 0, 'German CH', '', 'pkg_de-CH', 'package', '', 0, '3.7.4.2', '', 'https://update.joomla.org/language/details3/de-CH_details.xml', '', ''),
(54, 3, 0, 'German AT', '', 'pkg_de-AT', 'package', '', 0, '3.7.4.2', '', 'https://update.joomla.org/language/details3/de-AT_details.xml', '', ''),
(55, 3, 0, 'German LI', '', 'pkg_de-LI', 'package', '', 0, '3.7.4.2', '', 'https://update.joomla.org/language/details3/de-LI_details.xml', '', ''),
(56, 3, 0, 'German LU', '', 'pkg_de-LU', 'package', '', 0, '3.7.4.2', '', 'https://update.joomla.org/language/details3/de-LU_details.xml', '', ''),
(57, 3, 0, 'English NZ', '', 'pkg_en-NZ', 'package', '', 0, '3.6.5.1', '', 'https://update.joomla.org/language/details3/en-NZ_details.xml', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `frp_update_sites`
--

CREATE TABLE `frp_update_sites` (
...
--
-- Dumping data for table `frp_update_sites`
--

INSERT INTO `frp_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1503570178, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 1503570180, ''),
(4, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1503570181, ''),
(5, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `frp_update_sites_extensions`
--

CREATE TABLE `frp_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Dumping data for table `frp_update_sites_extensions`
--

INSERT INTO `frp_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(3, 802),
(4, 28),
(5, 10002);
...
--
-- Table structure for table `frp_usergroups`
--

CREATE TABLE `frp_usergroups` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
...
--
-- Dumping data for table `frp_usergroups`
--

INSERT INTO `frp_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `frp_users`
--
...
--
-- Dumping data for table `frp_users`
--

INSERT INTO `frp_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(634, 'Super User', 'admin', 'toanktv.it@gmail.com', '$2y$10$q/GHUMDbl8u6xH9AHtadK.AitE3NHQ3K53OsWfrqlnyLX10erPLvq', 0, 1, '2017-08-24 10:20:30', '2017-08-24 10:20:45', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `frp_user_keys`
--

CREATE TABLE `frp_user_keys` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `frp_user_notes`
--

CREATE TABLE `frp_user_notes` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `catid` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Table structure for table `frp_user_profiles`
--

CREATE TABLE `frp_user_profiles` (
...
--
-- Table structure for table `frp_user_usergroup_map`
--

CREATE TABLE `frp_user_usergroup_map` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `frp_user_usergroup_map`
--

INSERT INTO `frp_user_usergroup_map` (`user_id`, `group_id`) VALUES
(634, 8);

-- --------------------------------------------------------

--
-- Table structure for table `frp_utf8_conversion`
--

CREATE TABLE `frp_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `frp_utf8_conversion`
--

INSERT INTO `frp_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Table structure for table `frp_viewlevels`
--

CREATE TABLE `frp_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Dumping data for table `frp_viewlevels`
--

INSERT INTO `frp_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Indexes for table `frp_assets`
--
ALTER TABLE `frp_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `frp_associations`
--
ALTER TABLE `frp_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Indexes for table `frp_banners`
--
ALTER TABLE `frp_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `frp_banner_clients`
--
ALTER TABLE `frp_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Indexes for table `frp_banner_tracks`
--
ALTER TABLE `frp_banner_tracks`
...
--
-- Indexes for table `frp_categories`
--
ALTER TABLE `frp_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `frp_contact_details`
--
ALTER TABLE `frp_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Indexes for table `frp_content`
--
ALTER TABLE `frp_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indexes for table `frp_contentitem_tag_map`
--
ALTER TABLE `frp_contentitem_tag_map`
...
--
-- Indexes for table `frp_content_frontpage`
--
ALTER TABLE `frp_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `frp_content_rating`
--
ALTER TABLE `frp_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `frp_content_types`
--
ALTER TABLE `frp_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Indexes for table `frp_extensions`
--
ALTER TABLE `frp_extensions`
...
--
-- Indexes for table `frp_fields`
--
ALTER TABLE `frp_fields`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indexes for table `frp_fields_categories`
--
ALTER TABLE `frp_fields_categories`
  ADD PRIMARY KEY (`field_id`,`category_id`);

--
-- Indexes for table `frp_fields_groups`
--
ALTER TABLE `frp_fields_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indexes for table `frp_fields_values`
--
ALTER TABLE `frp_fields_values`
  ADD KEY `idx_field_id` (`field_id`),
  ADD KEY `idx_item_id` (`item_id`(191));

--
-- Indexes for table `frp_finder_filters`
--
ALTER TABLE `frp_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indexes for table `frp_finder_links`
--
ALTER TABLE `frp_finder_links`
...
--
-- Indexes for table `frp_finder_links_terms0`
--
ALTER TABLE `frp_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `frp_finder_links_terms1`
--
ALTER TABLE `frp_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `frp_finder_links_terms2`
--
ALTER TABLE `frp_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `frp_finder_links_terms3`
--
ALTER TABLE `frp_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `frp_finder_links_terms4`
--
ALTER TABLE `frp_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `frp_finder_links_terms5`
--
ALTER TABLE `frp_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `frp_finder_links_terms6`
--
ALTER TABLE `frp_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `frp_finder_links_terms7`
--
ALTER TABLE `frp_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `frp_finder_links_terms8`
--
ALTER TABLE `frp_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `frp_finder_links_terms9`
--
ALTER TABLE `frp_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `frp_finder_links_termsa`
--
ALTER TABLE `frp_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `frp_finder_links_termsb`
--
ALTER TABLE `frp_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `frp_finder_links_termsc`
--
ALTER TABLE `frp_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `frp_finder_links_termsd`
--
ALTER TABLE `frp_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `frp_finder_links_termse`
--
ALTER TABLE `frp_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `frp_finder_links_termsf`
--
ALTER TABLE `frp_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `frp_finder_taxonomy`
--
ALTER TABLE `frp_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `frp_finder_taxonomy_map`
--
ALTER TABLE `frp_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Indexes for table `frp_finder_terms`
--
ALTER TABLE `frp_finder_terms`
...
--
-- Indexes for table `frp_finder_terms_common`
--
ALTER TABLE `frp_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Indexes for table `frp_finder_tokens`
--
ALTER TABLE `frp_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Indexes for table `frp_finder_tokens_aggregate`
--
ALTER TABLE `frp_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Indexes for table `frp_finder_types`
--
ALTER TABLE `frp_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Indexes for table `frp_languages`
--
ALTER TABLE `frp_languages`
...
--
-- Indexes for table `frp_menu`
--
ALTER TABLE `frp_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `frp_menu_types`
--
ALTER TABLE `frp_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indexes for table `frp_messages`
--
ALTER TABLE `frp_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indexes for table `frp_messages_cfg`
--
ALTER TABLE `frp_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indexes for table `frp_modules`
--
ALTER TABLE `frp_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `frp_modules_menu`
--
ALTER TABLE `frp_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indexes for table `frp_newsfeeds`
--
ALTER TABLE `frp_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indexes for table `frp_overrider`
--
ALTER TABLE `frp_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `frp_postinstall_messages`
--
ALTER TABLE `frp_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indexes for table `frp_redirect_links`
--
ALTER TABLE `frp_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indexes for table `frp_schemas`
--
ALTER TABLE `frp_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indexes for table `frp_session`
--
ALTER TABLE `frp_session`
  ADD PRIMARY KEY (`session_id`),
  ADD KEY `userid` (`userid`),
  ADD KEY `time` (`time`);

--
-- Indexes for table `frp_tags`
--
ALTER TABLE `frp_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `frp_template_styles`
--
ALTER TABLE `frp_template_styles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_home` (`home`);

--
-- Indexes for table `frp_ucm_base`
--
ALTER TABLE `frp_ucm_base`
...
--
-- Indexes for table `frp_ucm_content`
--
ALTER TABLE `frp_ucm_content`
...
--
-- Indexes for table `frp_ucm_history`
--
ALTER TABLE `frp_ucm_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Indexes for table `frp_updates`
--
ALTER TABLE `frp_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indexes for table `frp_update_sites`
--
ALTER TABLE `frp_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indexes for table `frp_update_sites_extensions`
--
ALTER TABLE `frp_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indexes for table `frp_usergroups`
--
ALTER TABLE `frp_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `frp_users`
--
ALTER TABLE `frp_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `frp_user_keys`
--
ALTER TABLE `frp_user_keys`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `frp_user_notes`
--
ALTER TABLE `frp_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Indexes for table `frp_user_profiles`
--
ALTER TABLE `frp_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indexes for table `frp_user_usergroup_map`
--
ALTER TABLE `frp_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indexes for table `frp_viewlevels`
--
ALTER TABLE `frp_viewlevels`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `frp_assets`
--
ALTER TABLE `frp_assets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=59;
--
-- AUTO_INCREMENT for table `frp_banners`
--
ALTER TABLE `frp_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `frp_banner_clients`
--
ALTER TABLE `frp_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `frp_categories`
--
ALTER TABLE `frp_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `frp_contact_details`
--
ALTER TABLE `frp_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `frp_content`
--
ALTER TABLE `frp_content`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `frp_content_types`
--
ALTER TABLE `frp_content_types`
  MODIFY `type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000;
--
-- AUTO_INCREMENT for table `frp_extensions`
--
ALTER TABLE `frp_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10003;
--
-- AUTO_INCREMENT for table `frp_fields`
--
ALTER TABLE `frp_fields`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `frp_fields_groups`
--
ALTER TABLE `frp_fields_groups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `frp_finder_filters`
--
ALTER TABLE `frp_finder_filters`
  MODIFY `filter_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `frp_finder_links`
--
ALTER TABLE `frp_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `frp_finder_taxonomy`
--
ALTER TABLE `frp_finder_taxonomy`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `frp_finder_terms`
--
ALTER TABLE `frp_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `frp_finder_types`
--
ALTER TABLE `frp_finder_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `frp_languages`
--
ALTER TABLE `frp_languages`
  MODIFY `lang_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `frp_menu`
--
ALTER TABLE `frp_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
--
-- AUTO_INCREMENT for table `frp_menu_types`
--
ALTER TABLE `frp_menu_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `frp_messages`
--
ALTER TABLE `frp_messages`
  MODIFY `message_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `frp_modules`
--
ALTER TABLE `frp_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
--
-- AUTO_INCREMENT for table `frp_newsfeeds`
--
ALTER TABLE `frp_newsfeeds`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `frp_overrider`
--
ALTER TABLE `frp_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
-- AUTO_INCREMENT for table `frp_postinstall_messages`
--
ALTER TABLE `frp_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `frp_redirect_links`
--
ALTER TABLE `frp_redirect_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `frp_tags`
--
ALTER TABLE `frp_tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `frp_template_styles`
--
ALTER TABLE `frp_template_styles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `frp_ucm_content`
--
ALTER TABLE `frp_ucm_content`
  MODIFY `core_content_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `frp_ucm_history`
--
ALTER TABLE `frp_ucm_history`
  MODIFY `version_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `frp_updates`
--
ALTER TABLE `frp_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
--
-- AUTO_INCREMENT for table `frp_update_sites`
--
ALTER TABLE `frp_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `frp_usergroups`
--
ALTER TABLE `frp_usergroups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `frp_users`
--
ALTER TABLE `frp_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=635;
--
-- AUTO_INCREMENT for table `frp_user_keys`
--
ALTER TABLE `frp_user_keys`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `frp_user_notes`
--
ALTER TABLE `frp_user_notes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `frp_viewlevels`
--
ALTER TABLE `frp_viewlevels`
